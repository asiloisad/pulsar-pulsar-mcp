...
module.exports = {
  ...
  activate() {
    ...
    const oldDisabled = atom.config.get("pulsar-mcp.disabledTools");
    if (oldDisabled !== undefined) {
      atom.config.set("pulsar-mcp.toolList", oldDisabled);
      atom.config.set("pulsar-mcp.listMode", "blacklist");
      atom.config.unset("pulsar-mcp.disabledTools");
